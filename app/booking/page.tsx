...
export default function BookingPage() {
  ...
  return (
    <main style={{ maxWidth: 900, margin: "0 auto", padding: 24 }}>
      ...
      <p style={{ color: "#555", marginBottom: 24 }}>Sessões de 50 minutos com 5 min de tolerância antes e depois. Agendamentos com pelo menos 24h de antecedência. Valor: R$ 150,00.</p>
